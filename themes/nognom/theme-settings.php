 ...
 */
function nognom_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  global $base_url;
...
//  $uri = theme_get_setting('logo.path', 'nognom');
//  if (!empty($uri)) {
//    $file_url = file_create_url($uri);
//    $file_url = str_ireplace($base_url, '', $file_url);
//  }
//  else {
//    $file_url = '/' . drupal_get_path('theme', 'nognom') . '/logo.svg';
//  }
//  $js = array(
//    'logo_path' => $file_url,
//    'header_bg_file' => theme_get_setting('header_bg_file', 'nognom'),
//    'header_bg_alignment' => theme_get_setting('header_bg_alignment', 'nognom'),
//    'header_watermark' => theme_get_setting('header_watermark', 'nognom'),
//    'header_border_width' => theme_get_setting('header_border_width', 'nognom'),
//    'layout_style' => theme_get_setting('layout_style', 'nognom'),
//    'base_vmargin' => theme_get_setting('base_vmargin', 'nognom'),
//  );
//  $form['#attached']['drupalSettings']['color'] = $js;
//
//  // Get our plugin system functions.
//  require_once(drupal_get_path('theme', 'nognom') . '/inc/plugins.inc');
//
//  // We need some getters.
//  require_once(drupal_get_path('theme', 'nognom') . '/inc/get.inc');
//  $path_to_nognom = drupal_get_path('theme', 'nognom');
//
...
//  $device_group_options = page_layouts_device_group_options('nognom');
//
//  // Unit options
...
//    '#prefix' => '<img src="' . Url::fromUri('base:' . drupal_get_path('theme', 'nognom') . '/images/base-layout.png')->toString() . '" /><br />',
//  );
...
//    ),
//    '#description' => '<img src="' . Url::fromUri('base:' . drupal_get_path('theme', 'nognom') . '/images/page-layout.png')->toString() . '" /><br />' . t('When the layout 2 is selected, or header background image is selected, header borders are not drawn to make it look better.'),
//  );
//
...
//    '#collapsed' => TRUE,
//    '#attributes' => array(
//      'class' => array('nognom-layout-form'),
//    ),
//  );
//
//  // Big screen Layout
...
//    '#type' => 'checkbox',
//    '#title' => t('Use old legacy nognom styles for Superfish.'),
//    '#default_value' => theme_get_setting('legacy_superfish_styles'),
//    '#description' => t('Check here if you want to add nognom-superfish.css.'),
//  );
//  $form['style']['superfish_note'] = array(
//    '#type' => 'item',
//    '#title' => t('Note:'),
//    '#markup' => t('Use this only when coming from the older non-responsive versions of nognom
//     and your Superfish menu is broken without it. If you haven\'t been using Superfish or are
//     installing nognom for the first time you shouldn\'t need it and can leave it unchecked.'),
//  );
...
//    ),
//    '#suffix' => '<img src="' . Url::fromUri('base:' . drupal_get_path('theme', 'nognom') . '/images/round-corners.png')->toString() . '" /><br />',
//  );
//
...
//    ),
//    '#suffix' => '<img src="' . Url::fromUri('base:' . drupal_get_path('theme', 'nognom') . '/images/menubar-type.png')->toString() . '" />',
//  );
...
//  );
  ...
  $form['adv_header']['header_bg'] = array(
    ...
    '#element_validate' => array('nognom_header_bg_validate'),
  );
...
//      6 => t('Metal'),
//    ),
//    '#suffix' => '<img src="' . Url::fromUri('base:' . drupal_get_path('theme', 'nognom') . '/images/watermark-sample.png')->toString() . '" /><br />',
//  );
//
...
//  require_once(drupal_get_path('theme', 'nognom') . '/inc/forms/nognom.validate.inc');
//  require_once(drupal_get_path('theme', 'nognom') . '/inc/forms/nognom.submit.inc');
//
...
//  $form['#validate'][] = 'nognom_settings_validate';
//  $form['#submit'][] = 'nognom_settings_submit';
}

/**
 * Check and save the uploaded header background image
 */
function nognom_header_bg_validate($element, FormStateInterface $form_state) {
  global $base_url;
